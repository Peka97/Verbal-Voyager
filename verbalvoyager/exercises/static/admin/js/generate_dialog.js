...
function GenerateButtonClickHandler() {
	...
	const langID = document.querySelector("#id_lang").value;
	let Words = Array();
	...
	SendToGenerateText(langID, Words, GenerateСounterInput.value, GenerateSelectLevelElement.value);
}
...
function SendToGenerateText(langID, wordsIDs, sentencesCount, level) {
	if (!langID) {
