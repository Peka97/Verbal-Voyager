...
if __name__ == '__main__':
    ...
    from dictionary.models import FrenchWord, SpanishWord
    from dictionary.models import Language, Word, Translation
    from dictionary.models import EnglishWordDetail, FrenchWordDetail, SpanishWordDetail, RussianWordDetail
